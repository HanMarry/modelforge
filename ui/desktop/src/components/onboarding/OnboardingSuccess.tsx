...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: "You're all set to start using ModelForge.",
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage: 'Anonymous usage data helps improve ModelForge. We never collect your conversations, code, or personal data.',
  },
  learnMore: {
