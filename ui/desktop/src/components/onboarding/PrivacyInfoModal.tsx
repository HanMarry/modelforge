...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Anonymous usage data helps us understand how ModelForge is used and identify areas for improvement.',
  },
  whatWeCollect: {
  ...
  collectVersion: {
    ...
    defaultMessage: 'ModelForge version and install method',
  },
  collectProvider: {
