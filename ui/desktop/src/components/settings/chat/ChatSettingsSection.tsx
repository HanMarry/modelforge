...
const i18n = defineMessages({
  ...
  modeDescription: {
    ...
    defaultMessage: 'Choose the default mode ModelForge uses for new sessions. Existing sessions keep their current mode.',
  },
  responseStylesTitle: {
  ...
  responseStylesDescription: {
    ...
    defaultMessage: 'Choose how ModelForge should format and style its responses',
  },
});
