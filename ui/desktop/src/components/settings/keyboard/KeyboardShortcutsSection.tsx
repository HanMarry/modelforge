...
const i18n = defineMessages({
  ...
  focusWindowLabel: {
    ...
    defaultMessage: 'Focus ModelForge Window',
  },
  focusWindowDescription: {
    id: 'keyboardShortcuts.focusWindowDescription',
    defaultMessage: 'Bring ModelForge window to front from anywhere',
  },
  quickLauncherLabel: {
  ...
  newChatWindowDescription: {
    ...
    defaultMessage: 'Open a new ModelForge window',
  },
  openDirectoryLabel: {
  ...
  categoryGlobalDescription: {
    ...
    defaultMessage: 'These shortcuts work system-wide, even when ModelForge is not focused',
  },
  categoryApplication: {
  ...
  categoryApplicationDescription: {
    ...
    defaultMessage: 'These shortcuts work when ModelForge is the active application',
  },
  categorySearch: {
  ...
  restartDescription: {
    ...
    defaultMessage: 'Changes to application shortcuts (like New Chat, Settings, etc.) require restarting ModelForge to take effect. Global shortcuts (Focus Window, Quick Launcher) work immediately.',
  },
  dismiss: {
