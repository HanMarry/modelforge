...
import AgentKernelSection from './AgentKernelSection';
...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how ModelForge appears on your system',
  },
  ...
  taskNotificationsDesc: {
    ...
    defaultMessage: 'Notify when ModelForge finishes a task while the window is in the background',
  },
  menuBarIcon: { id: 'settings.menuBarIcon.title', defaultMessage: 'Menu bar icon' },
  menuBarIconDesc: {
    id: 'settings.menuBarIcon.description',
    defaultMessage: 'Show ModelForge in the menu bar',
  },
  dockIcon: { id: 'settings.dockIcon.title', defaultMessage: 'Dock icon' },
  dockIconDesc: { id: 'settings.dockIcon.description', defaultMessage: 'Show ModelForge in the dock' },
  preventSleep: { id: 'settings.preventSleep.title', defaultMessage: 'Prevent Sleep' },
  preventSleepDesc: {
    id: 'settings.preventSleep.description',
    defaultMessage: 'Keep your computer awake while ModelForge is running a task (screen can still lock)',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of ModelForge',
  },
  languageTitle: { id: 'settings.language.title', defaultMessage: 'Language' },
  languageDesc: {
    id: 'settings.language.description',
    defaultMessage: 'Choose the display language for ModelForge',
  },
  ...
  helpDesc: {
    ...
    defaultMessage: 'Help us improve ModelForge by reporting issues or requesting new features',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install updates to keep ModelForge running at its best',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select ModelForge in the application list',
  },
