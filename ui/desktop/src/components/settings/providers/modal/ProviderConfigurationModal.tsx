...
const i18n = defineMessages({
  ...
  addApiKeyDescription: {
    ...
    defaultMessage: 'Add your API key(s) for this provider to integrate into ModelForge',
  },
  oauthLoginFailed: {
  ...
  externalSetupIntro: {
    ...
    defaultMessage: 'This provider is configured outside of ModelForge. Follow these steps:',
  },
  chooseModel: {
